...
namespace ocs2::legged_robot
{
    ...
    {
        // Splice handling has moved to PerceptiveLeggedReferenceManager —
        // see the header comment for why. This module now only handles
        // gait-template switches triggered by joystick command changes.
        getTargetGait();
        if (gait_updated_)
        {
