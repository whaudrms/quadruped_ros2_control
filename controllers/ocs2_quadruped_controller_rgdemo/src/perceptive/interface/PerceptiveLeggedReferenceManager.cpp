...
namespace ocs2::legged_robot
{
                                                            ...
                                                            ModeSchedule& modeSchedule)
    {
        ...
        for (size_t i = 0; i < nodeNum; ++i)
        {
            ...
            const scalar_t terrainPitchWeight = scalar_t(0.08) * warmupAlpha;
            ...
            const scalar_t zStepLimit = scalar_t(0.03) + warmupAlpha * scalar_t(0.05);
            ...
            centroidal_model::getBasePose(state, info_)(2) =
                std::max(centroidal_model::getBasePose(state, info_)(2), limitedTerrainHeight);
