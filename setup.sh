...
echo "===== Step 2: Build base packages ====="
...
echo "===== Step 3: Clone ocs2_ros2 ====="
cd ~/ros2_ws/src
git clone https://github.com/legubiao/ocs2_ros2

echo "===== Step 4: Init submodules ====="
cd ~/ros2_ws/src/ocs2_ros2
git submodule update --init --recursive

echo "===== Step 5: Install dependencies again ====="
cd ~/ros2_ws
rosdep install --from-paths src --ignore-src -r -y

echo "===== Step 6: Build ocs2 controller (1st pass) ====="
colcon build --packages-up-to ocs2_quadruped_controller \
    --symlink-install \
    --parallel-workers 1

echo "===== Step 7: Build ocs2 controller (Debug patch build) ====="
colcon build --packages-up-to ocs2_quadruped_controller \
